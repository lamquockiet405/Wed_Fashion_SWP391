...
<html lang="en">
    <head>
        ...
        <title>Shop Information - Admin Panel</title>
    ...
    <body>
        ...
        <header class="header">
            ...
            <div class="search-container">
                <form action="ManageShopURL" method="get">
                    <input type="text" placeholder="Search shops..." name="search">
                </form>
            </div>
            <div class="user-info">
                ...
                <div class="shop-info-container">
                    ...
                    <div class="shop-info-content">
                            ...
                            <div class="profile-header">
                                <c:choose>
                                    <c:when test="${not empty shop.logo}">
                                        <img src="${shop.logo}" alt="Shop Logo" class="profile-img">
                                    </c:when>
                                    <c:otherwise>
                                        <img src="images/avtdf.jpg" alt="Shop Logo" class="profile-img">
                                    </c:otherwise>
                                </c:choose>                        
                                <h2 class="profile-name">${shop.name}</h2>
                            </div>
                            
                            <table class="info-table">
                                <tr>
                                    <th><i class="fas fa-receipt"></i> Tax Number</th>
                                    <td>${shop.tax}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/ViewUserInformation?userID=${user.userID}" class="info-link">
                                            <i class="fas fa-eye"></i> View Owner Details
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="action-buttons">
                            <a href="/Ecommerce_SWP/ManageShopURL" class="action-btn btn-secondary">
