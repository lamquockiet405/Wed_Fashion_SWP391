 ...
 * @author lenovo
 */
@WebServlet(name = "NewPasswordUpdate", urlPatterns = {"/newPasswordUpdate"})
 ...
 private static final long serialVersionUID = 1L;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NewPasswordUpdate</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewPasswordUpdate at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        DAOForgotPassword userDAO = new DAOForgotPassword();
        MaHoa ma = new MaHoa();
        ...
        if (!newPassword.equals("") && !confPassword.equals("") && newPassword.equals(confPassword)) {
            ...
            if (success) {
                ...
                request.getRequestDispatcher("View/ForgotPassword/newPassword.jsp").forward(request, response);
            }
    }
    }
    /**
